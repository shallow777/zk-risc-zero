...
impl<'a, H: Hal> Prover<'a, H> {
    ...
    pub fn commit_group(&mut self, tap_group_index: usize, witness: &H::Buffer<H::Elem>) {
        ...
        let intt_time = start_time.elapsed();
        println!("intt time: {:?}", intt_time);
        ...
        C: CircuitHal<H>,
    {
        ...
        let intt_time = start_time.elapsed();
        println!("check_poly intt time: {:?}", intt_time);
        ...
        let interpolate_time = start_time.elapsed();
        println!("poly_interpolate time: {:?}", interpolate_time);
        ...
        let mix_time = start_time.elapsed();
        println!("mixc time: {:?}", mix_time);
        ...
        let mix_time = start_time.elapsed();
        println!("mix_poly_coeffs time: {:?}", mix_time);
        ...
        let divide_time = start_time.elapsed();
        println!("divide time: {:?}", divide_time);
        ...
        let bit_rev_time = start_time.elapsed();
        println!("bit_rev time: {:?}", bit_rev_time);

        tracing::debug!("FRI-proof, size = {}", final_poly_coeffs.size() / ext_size);
        println!("FRI-proof, size = {}", final_poly_coeffs.size() / ext_size);
        let start_time = Instant::now();
        ...
        let fri_time = start_time.elapsed();
        println!("fri time: {:?}", fri_time);
